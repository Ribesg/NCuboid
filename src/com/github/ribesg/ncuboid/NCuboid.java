...
import com.github.ribesg.ncuboid.listeners.flag.FeedFlagListener;
...
import com.github.ribesg.ncuboid.listeners.flag.HealFlagListener;
...
public class NCuboid extends CuboidNode {
    ...
    public void onEnable() {
        ...
        pm.registerEvents(new FeedFlagListener(this), this);
        pm.registerEvents(new FireFlagListener(this), this);
        pm.registerEvents(new GodFlagListener(this), this);
        pm.registerEvents(new HealFlagListener(this), this);
